...
namespace Xin\Payment\Kernel\Log;
...
class LogManager implements LoggerInterface{
	...
	protected function createEmergencyLogger(){
		return new Monolog('Payment', $this->prepareHandlers([
			new StreamHandler(
				\sys_get_temp_dir().'/payment/payment.log',
