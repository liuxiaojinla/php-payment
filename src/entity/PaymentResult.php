...
class PaymentResult extends PaymentData{
	 ...
	 */
	public static function fromXML($xml, ConfigInterface $config){
		if(!$xml){
	 ...
	 * @return static
	 */
	public static function formStdClass($stdClass, ConfigInterface $config){
		return new static((array)$stdClass, $config);
	}
