 ...
 * @method void setTradeType($tradeType) 设置交易类型
 ...
 * @method bool hasLimitPay() 是否指定支付方式
 * @method string getOpenid() 获取用户标识
 * @method void setOpenid($openid) 设置用户标识
 * @method bool hasOpenid() 是否设置用户标识
 * @method string getSubAppid() 获取子appid
 * @method void setSubAppid($subAppid) 设置子appid
 * @method bool hasSubAppid() 是否设置子appid
 * @method void getSubOpenid() 获取子openid
 * @method void setSubOpenid($subOpenid) 设置子openid
 * @method bool hasSubOpenid() 是否设置子openid
 * @method string getAuthCode() 获取设置支付付款码
 * @method void setAuthCode(string $string) 设置支付付款码
 * @method bool hasAuthCode() 是否设置支付付款码
 */
class UnifiedOrderInput extends Input{
